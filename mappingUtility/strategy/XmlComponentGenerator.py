...
from mappingUtility.Utility import XmlUtils
...
class XMLProcessor(FileProcessor):
    ...
    def build_xml_profile_structure(component, root_element, key_counter):
        ...
        profile = SubElement(
            bns_object, "XMLProfile", {"modelVersion": "2", "strict": "true"}
        )
        ...
        SubElement(
            ...
            {
                "encoding": "utf8",
                "implicitElementOrdering": "true",
                "parseRespectMaxOccurs": "true",
        ...
        xml_namespace = SubElement(
            namespaces, "XMLNamespace", {"key": "-1", "name": "Empty Namespace"}
        )
    ...
    def generate_boomi_xml_from_xml(xml_data, is_source=True):
        ...
        return (
            parseString(tostring(component, encoding="utf-8"))
