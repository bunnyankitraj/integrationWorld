from mappingUtility.service import BoomiComponentUploader,MappingComponentXmlGenerator, ProfileComponentGenerator,ComponentService;
import json
...
def process_mapping_files(source_data, destination_data, excel_data):
    try:
        ...
        sourceTempXml = ProfileComponentGenerator.generate_profile_xml(source_data, isSource=True)
        ...
        destinationTempXml = ProfileComponentGenerator.generate_profile_xml(destination_data, isSource=False)
